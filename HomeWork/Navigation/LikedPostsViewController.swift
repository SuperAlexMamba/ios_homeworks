...
class LikedPostsViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.viewsLabel.text = "\(NSLocalizedString("views_key", comment: "")) \(String(describing: item.views))"
        cell.likesLabel.text = "\(NSLocalizedString("likes_key", comment: "")) \(String(describing: item.likes))"
    ...
    @objc func searchPost() {
        ...
        let alert = UIAlertController(title: NSLocalizedString("filter_key", comment: ""), message: NSLocalizedString("alert_filter_message", comment: ""), preferredStyle: .alert)
        
        alert.addTextField { textField in
            textField.placeholder = NSLocalizedString("author_key", comment: "")
        }
        
        let searchAction = UIAlertAction(title: NSLocalizedString("search_key", comment: ""), style: .default) { [weak alert , weak self] _ in
    ...
    private func setupView() {
        ...
        let resetFilterButton = UIBarButtonItem(title: NSLocalizedString("reset_button_liked_posts_key", comment: ""), style: .done, target: self, action: #selector(resetFilter))
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deleteAction = UIContextualAction(style: .normal, title: NSLocalizedString("delete_key", comment: "")) { [weak self] (action, view, completion) in
