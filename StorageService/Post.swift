...
public var postOne = Post(author: "the.wither.fans", text: "Наш с вами любимый Геральт из Ривии", image: UIImage(named: "wither")!, likes: 442, views: 1600)

public var postTwo = Post(author: "space.life", text: "Красота космоса", image: UIImage(named: "space")!, likes: 255, views: 871)
...
public var postFour = Post(author: "game.of.thrones", text: "кадры последнего 8 сезона сериала Игра Престолов ", image: UIImage(named: "game")!, likes: 543, views: 1407)
